...
public class DoubleShadowBubbleTextView extends BubbleTextView
{
    ...
    public static class ShadowInfo
    {
        ...
        public ShadowInfo(final Context context, final AttributeSet set, final int n) {
            final TypedArray obtainStyledAttributes = context.obtainStyledAttributes(set, new int[] { R.attr.ambientShadowColor, R.attr.ambientShadowBlur, R.attr.keyShadowColor, R.attr.keyShadowBlur, R.attr.keyShadowOffset }, n, 0);
